    ...
    <div className="min-h-screen flex items-center justify-center bg-light-50 dark:bg-dark px-4">
      <div className="text-center max-w-md">
        ...
        >
          ...
          <button
            onClick={reset}
            className="mt-6 inline-flex items-center gap-2 px-6 py-3 bg-accent text-white rounded-xl font-semibold text-sm hover:bg-accent-dark transition-all shadow-lg shadow-accent/25"
          >
            Try Again
          </button>
        </motion.div>
