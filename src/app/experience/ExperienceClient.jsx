...
export default function ExperienceClient({ experienceData, educationData }) {
  return (
    <div className="pt-24">
            ...
            <AnimatedSection>
              ...
              {experienceData.map((exp, i) => (
                <motion.div
                  ...
                  className="p-8 rounded-2xl bg-gradient-to-br from-accent/5 to-transparent border border-accent/10 mb-6"
                >
